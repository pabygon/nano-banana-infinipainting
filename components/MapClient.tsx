...
export default function MapClient() {
  ...
  return (
    ...
    {/* Instructions message at bottom - moved outside main container */}
    <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 z-[10003] pointer-events-none">
      <div className="bg-black/90 text-white px-6 py-3 rounded-lg text-sm max-w-md text-center backdrop-blur-sm border border-blue-500/50 shadow-lg">
        <div className="flex items-center justify-center gap-2">
          <svg className="w-4 h-4 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
          <span>
            Zoom to max level → Click any tile → Generate content
          </span>
        </div>
      </div>
    </div>
